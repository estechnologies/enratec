...
<div class="account-container">
	...
	<div class="content clearfix">
		...
		<form action="teamLoginBack.php" method="post">
			...
			<div class="login-fields">
				...
				<div class="field">
					...
					<input type="text" id="username" name="username" value="<?php if(isset($_GET['name'])){echo $_GET['name'];}?>" required placeholder="Username" class="login username-field" />
				</div> <!-- /field -->
